...
// Componente Wrapper para as animações
...
export default function App() {
  ...
  // Efeito para o Header transparente/sólido
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-zinc-300 font-sans selection:bg-zinc-100 selection:text-black">
      {/* Estilos Globais Injetados para o Footer Reveal e Tipografia Serifada */}
      <style dangerouslySetInnerHTML={{
        ...
        .reveal-wrapper {
          ...
          margin-bottom: 100vh; /* Para mobile */
        }
        @media (min-width: 768px) {
          .reveal-wrapper {
            margin-bottom: 500px; /* Altura do footer no desktop */
          }
        }
        .reveal-footer {
          position: fixed;
      ...
      <nav className={`fixed w-full z-50 transition-all duration-500 ${isScrolled ? 'bg-[#0a0a0a]/90 backdrop-blur-md py-4 border-b border-zinc-800/50' : 'bg-transparent py-6'}`}>
        ...
        <div className={`md:hidden absolute top-full left-0 w-full bg-[#0a0a0a] border-b border-zinc-800 transition-all duration-300 overflow-hidden ${mobileMenuOpen ? 'max-h-96 py-6' : 'max-h-0 py-0 border-transparent'}`}>
          <div className="flex flex-col items-center space-y-6">
            ...
            >
              Plantão 24h <Phone className="w-4 h-4" />
            </a>
          </div>
        </div>
      </nav>

      {/* WRAPPER PRINCIPAL PARA O EFEITO DE FOOTER */}
      <main className="reveal-wrapper shadow-[0_20px_50px_rgba(0,0,0,1)]">
        ...
        <section className="relative min-h-screen flex items-center pt-20 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 w-full">
            <div className="max-w-3xl">
              ...
              <FadeIn delay={500}>
                <p className="text-lg md:text-xl text-zinc-400 max-w-xl mb-12 font-light leading-relaxed">
                  Atuação especializada em Direito Penal. Estratégia, discrição e agilidade nos momentos em que você mais precisa de segurança.
                </p>
              </FadeIn>
              ...
              <FadeIn delay={700}>
                <div className="flex flex-col sm:flex-row gap-6">
                  ...
                  >
                    ...
                    <span className="relative z-10 uppercase tracking-widest text-sm font-semibold">Emergência Criminal 24h</span>
                  </a>
                  <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="relative">
                  ...
                  <div className="relative z-10 grayscale hover:grayscale-0 transition-all duration-1000">
                    <img
                      ...
                      onError={(e: any) => { e.target.src = 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?auto=format&fit=crop&q=80&w=1000'; }}
                    />
                    <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-white/90 to-transparent">
                      <p className="font-serif text-2xl text-black">Dra. Joicy Santos</p>
                      <p className="text-zinc-500 text-sm tracking-widest uppercase mt-1">OAB/SP 123.456</p>
                    </div>
                  </div>
                </div>
              </FadeIn>
              ...
              <FadeIn direction="left" delay={200}>
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <span className="text-black uppercase tracking-[0.2em] text-xs font-semibold">Sobre a Dra. Joicy</span>
                </div>
                <h2 className="font-serif text-4xl md:text-5xl text-black mb-8 leading-tight">
                  Dedicação exclusiva e incansável à <span className="text-zinc-500 italic">defesa dos seus direitos.</span>
                </h2>
          ...
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <FadeIn className="text-center mb-20">
              ...
              <p className="text-zinc-400 max-w-2xl mx-auto font-light">
                Foco exclusivo em Direito Penal, oferecendo defesa especializada em todas as fases do processo e em diversas complexidades.
              </p>
            </FadeIn>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                { title: 'Tribunal do Júri', desc: 'Defesa técnica e combativa em crimes dolosos contra a vida, com atuação estratégica em plenário.' },
                { title: 'Habeas Corpus', desc: 'Impetração de medidas urgentes visando a garantia da liberdade de locomoção em todas as instâncias.' },
                { title: 'Crimes Econômicos', desc: 'Defesa especializada em crimes contra a ordem tributária, lavagem de dinheiro e corrupção (White-Collar Crimes).' },
                { title: 'Direito Penal Médico', desc: 'Atuação na defesa de profissionais da saúde em casos de supostos erros médicos e negligência.' },
                ...
                <FadeIn key={idx} delay={idx * 100}>
                  <div className="group relative p-8 border border-zinc-800 bg-[#0d0d0d] hover:bg-zinc-900 transition-all duration-500 overflow-hidden h-full flex flex-col justify-between">
                    ...
                    <div>
                      <Gavel className="w-8 h-8 text-white mb-6 stroke-1" />
                      <h3 className="font-serif text-xl text-white mb-4 group-hover:text-zinc-200 transition-colors">{service.title}</h3>
                      <p className="text-zinc-500 text-sm font-light leading-relaxed">{service.desc}</p>
                    </div>

                    <div className="mt-8 flex items-center text-xs tracking-widest uppercase text-white font-semibold">
                      <span className="opacity-0 -translate-x-4 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0">Saiba mais</span>
                      <ArrowRight className="w-4 h-4 ml-2 opacity-0 -translate-x-4 transition-all duration-300 delay-75 group-hover:opacity-100 group-hover:translate-x-0" />
                    </div>
                  </div>
                </FadeIn>
              ))}
        ...
        <section id="diferenciais" className="py-32 bg-white text-black relative overflow-hidden">
          <div className="absolute right-0 top-0 w-1/2 h-full bg-zinc-100 transform -skew-x-12 translate-x-32 hidden lg:block"></div>
          <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            <div className="max-w-3xl">
              <FadeIn>
                ...
                <p className="text-zinc-600 text-lg mb-10 max-w-xl">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <a
                    href="https://wa.me/5511999999999"
                    className="px-8 py-4 bg-black text-white hover:bg-zinc-800 transition-colors uppercase tracking-widest text-sm font-semibold flex items-center justify-center gap-3"
                  >
                    Falar com Advogada Agora <ChevronRight className="w-4 h-4" />
                  </a>
                </div>
              </FadeIn>
            </div>
      ...
      {/* FOOTER - REVEAL EM CORTINA */}
      {/* Este footer fica preso ao fundo da tela (fixed bottom-0).
        Ele é revelado naturalmente quando o usuário chega ao final do `<main>` (que tem um margin-bottom correspondente à altura do footer e um z-index maior).
      */}
